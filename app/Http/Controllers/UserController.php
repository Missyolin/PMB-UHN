...
{
    $id_pendaftar = auth()->user()->id; // Ambil id_pendaftar dari pengguna yang sedang login
    ...
    $konfirmasiStatus = $pendaftaran->isNotEmpty() && $pendaftaran->first()->flag_is_formulir_verified == 1;
